...
class MPC_controller:
    ...
    def plot_tracking_results(self, t, x):
        ...
        ax1.plot(self.trajectory_params["t"], self.trajectory_params["x"], label="x_ref")
        ax1.legend()
        ax1.set_xlabel("Time (s)")
        ...
        ax2.plot(self.trajectory_params["t"], self.trajectory_params["vx"], label="vx_ref")
        ax2.legend()
        ax2.set_xlabel("Time (s)")
        ...
        ax3.plot(self.trajectory_params["t"], self.trajectory_params["y"], label="y_ref")
        ax3.legend()
        ax3.set_xlabel("Time (s)")
        ...
        ax4.plot(self.trajectory_params["t"], self.trajectory_params["vy"], label="vy_ref")
        ax4.legend()
        ax4.set_xlabel("Time (s)")
        ...
        ax5.plot(self.trajectory_params["t"], np.rad2deg(self.trajectory_params["gamma"]), label="gamma_ref")
        ax5.legend()
        ax5.set_xlabel("Time (s)")
        ...
        ax6.plot(self.trajectory_params["t"], np.rad2deg(self.trajectory_params["gamma_dot"]), label="gamma_dot_ref")
        ax6.legend()
        ax6.set_xlabel("Time (s)")
