...
class Trajectory:
    ...
    def add_new_configuration(self, states: Union[dict, str], env_params: dict, rocket_params: dict, controller_params: dict):
    ...
    def generate_trajectory(self, total_time: float) -> dict:
        ...
        Px_coeffs, Py_coeffs, Pz_coeffs, t = coupled_pol_interpolation(states_copy, self.rocket_params, self.controller_params, self.env_params)
